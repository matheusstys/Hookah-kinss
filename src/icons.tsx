...
export function Flame({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 3c1 3-1.5 4-1.5 6.5A2.5 2.5 0 0 0 13 12c1.5-1 1-3 1-3 2 1.5 3 3.7 3 6a5 5 0 0 1-10 0c0-2.5 1.5-4 2-5.5C9.8 7.7 10.5 5 12 3Z" />
    </svg>
  )
}
export function Cocktail({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
      <path d="M4 4h16l-8 8-8-8Z" />
      <path d="M12 12v7M8 21h8M7 7h10" />
    </svg>
  )
}
...
export function Users({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M16 5.5a3 3 0 0 1 0 5.5M22 20a6 6 0 0 0-4-5.6" />
    </svg>
  )
}
